...
def data_reader(config, dataset="Fdataset", disease_disease_topk=7, drug_drug_topk=7):
    ...
    print("drug count :{}".format(drug_num))
    print("disease count:{}".format(disease_num))
...
def case_data_reader(config, dataset="Fdataset", disease_disease_topk=7, drug_drug_topk=7):
...
def analysis_data_reader(config, specific_id, dataset="Fdataset", disease_disease_topk=7, drug_drug_topk=7):
